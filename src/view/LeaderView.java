...
public class LeaderView extends JFrame {
    ...
    private void setUp() {
        ...
        JLabel2D titleLabel = new JLabel2D("Leaderboard");
        titleLabel.setForeground(new Color(219, 237, 247));
        titleLabel.setOutlineColor(new Color(119, 137, 147));
        ...
        ArrayList<String> topUsers = controller.getTopUsers();
