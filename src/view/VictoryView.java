...
public class VictoryView extends JFrame {
    ...
    private void setUp() {
        ...
        JLabel2D titleLabel = new JLabel2D("Victory");  
        titleLabel.setFont(new Font("Stencil", Font.PLAIN, 100));
        titleLabel.setOutlineColor(new java.awt.Color(255, 211, 61));
        titleLabel.setEffectIndex(JLabel2D.EFFECT_GRADIENT);
        GradientPaint gp = new GradientPaint(0, 0, Color.red, 100, 50, Color.blue, true);
        titleLabel.setGradient(gp);
        ...
        JLabel2D userLabel = new JLabel2D("Congrats, " + username);
        userLabel.setForeground(new java.awt.Color(219, 237, 247));
        userLabel.setOutlineColor(new java.awt.Color(00,9,216));
        userLabel.setStroke(new BasicStroke(0.75f));
        userLabel.setFont(new Font("Stencil", Font.PLAIN, 24));
        ...
        centerPanel.add(Box.createRigidArea(new Dimension(0, 70))); // AI generated
