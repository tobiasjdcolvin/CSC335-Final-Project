...
import controller.LoserController;

public class LoserView extends JFrame {
    private String username;
    private LoserController controller;

    public LoserView(String username) {
        this.username = username;
        this.controller = new LoserController(new LoserModel(this, username));
    ...
    private void setUp() {
        ...
        JLabel userLabel = new JLabel("Damn " + username + " you suck LMAOOOOOOOO");
